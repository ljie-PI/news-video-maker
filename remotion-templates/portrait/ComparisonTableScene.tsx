...
export const ComparisonTableScene: React.FC<ComparisonTableSceneProps> = ({
  ...
  const portraitSmallFont = colCount > 3;
  const fontScale = (portraitSmallFont ? 0.8 : 1) * fScale;
            ...
            {columns.map((col, ci) => (
              <div
                ...
                style={{
                  ...
                  fontWeight: 700,
                  color: "#ffffff",
                  padding: portraitSmallFont ? `${Math.round(20 * vScale)}px 16px` : `${Math.round(24 * vScale)}px 28px`,
                ...
                {row.cells.map((cell, ci) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: portraitSmallFont ? `${Math.round(18 * vScale)}px 14px` : `${Math.round(24 * vScale)}px 24px`,
                      boxSizing: "border-box",
                      lineHeight: 1.4,
                    }}
                  >
